...
$GLOBALS['sql']->exec("INSERT INTO media (media_name, state) VALUES ('$media_name', s$statetate)");
$new_media = $GLOBALS['sql']->query("SELECT id, media_namstateate FROM media WHERE media_name='$media_name'")[0];
