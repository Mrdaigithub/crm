...
$GLOBALS['sql']->exec("UPDATE media SET state=s$statetate WHERE id='$media_id'");
$new_media = $GLOBALS['sql']->query("SELECT id, media_namstateate FROM media WHERE id='$media_id'")[0];
