...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $role_name_list = $sql->query("SELECT role_name, state, fixed FROM role");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql->exec("INSERT INTO role (role_name, permission) VALUES ('" . $_POST['new_role_name'] . "','$new_role_permission')");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    $sql->exec("DELETE FROM role WHERE role_name='" . $req_args['role_name'] . "'");
    exit();
}
